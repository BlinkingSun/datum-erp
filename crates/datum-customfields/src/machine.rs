...
//! the same way it registers [`datum_documents::document_machine`]. The catalog
...
pub fn retire_context(ctx: datum_db::WriteContext, id: DefinitionId) -> datum_db::WriteContext {
