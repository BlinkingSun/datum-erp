...
ALTER TABLE app.event OWNER TO datum_owner;
GRANT SELECT, INSERT, UPDATE ON TABLE app.event TO datum_app;
...
ALTER TABLE app.subscription OWNER TO datum_owner;
GRANT SELECT, INSERT, UPDATE ON TABLE app.subscription TO datum_app;
...
ALTER TABLE transient.delivery OWNER TO datum_owner;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE transient.delivery TO datum_app;
