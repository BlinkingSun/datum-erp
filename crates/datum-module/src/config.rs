...
pub async fn persist_kernel_defaults(tx: &mut datum_db::Tx<'_>, profile: &Profile) -> Result<()> {
...
pub async fn load_kernel_defaults(pool: &datum_db::Pool) -> Result<KernelDefaults> {
