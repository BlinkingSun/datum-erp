...
//!
//! Wires [`wicket_core::PostingSink`] ([`wicket_ledger::GroupBuilder`]) and
//! [`wicket_esign::GateFactory`] (`NoSignatures` or the prepared esign gate).
...
mod _wave_2s1_dev_deps {
    use wicket_mod_items as _;
    use wicket_mod_locations as _;
    use wicket_mod_lots as _;
}
